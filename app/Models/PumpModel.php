...
class PumpModel extends Model
{
  ...
  protected $allowedFields    = ['floor', 'room', 'name', 'vendor', 'brand', 'type', 'condition', 'info', 'install', 'updated_at'];
  ...
  public function getFilteredData($search, $start, $length)
  {
    ...
    $builder->select('floor, room, name, vendor, brand, type, condition, info, install')
      ->limit($length, $start);
