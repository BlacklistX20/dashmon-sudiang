...
class SecurityModel extends Model
{
  ...
  protected $allowedFields    = ['floor', 'room', 'vendor', 'brand', 'type', 'quantity',  'condition', 'status', 'info', 'install', 'maintanance', 'updated_at'];
  ...
  public function getFilteredData($search, $start, $length)
  {
    ...
    $builder->select('floor, room, vendor, brand, type, quantity,  condition, status, info, install, maintanance')
      ->limit($length, $start);
