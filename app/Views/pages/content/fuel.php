...
<div class="tank-container">
   <div class="tankDaily text-center cardCustom">
      <h2 class="fw-bold">Tangki Harian</h2>
      <p>Last Update : <span id="dateDailyTank"></span></p>
      <div class="row">
         <div class="col-6">
            <h3 class="fw-bold">Tangki 1</h3>
            <h3 class="mb-3"><span id="tank1Value">0</span> L / 1500 L</h3>
            <div class="tank-bar">
         ...
         <div class="col-6">
            <h3 class="fw-bold">Tangki 2</h3>
            <h3 class="mb-3"><span id="tank2Value">0</span> L / 1500 L</h3>
            <div class="tank-bar">
   ...
   <div class="tankmonthly text-center cardCustom">
      ...
      <div class="row">
         <div class="col-4">
            <h3 class="fw-bold">Tangki 1</h3>
            <h3 class="mb-3"><span id="tank3Value">0</span> L / 10000 L</h3>
            <div class="tank-bar">
         ...
         <div class="col-4">
            <h3 class="fw-bold">Tangki 2</h3>
            <h3 class="mb-3"><span id="tank4Value">0</span> L / 10000 L</h3>
            <div class="tank-bar">
         ...
         <div class="col-4">
            <h3 class="fw-bold">Tangki 3</h3>
            <h3 class="mb-3"><span id="tank5Value">0</span> L / 10000 L</h3>
            <div class="tank-bar">
